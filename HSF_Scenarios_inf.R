...
FisheriesMet <- subset(FisheriesMet, is.na(inf_intercept)==FALSE) # remove all csquares with missing inf_intercept 
FisheriesMet <- subset(FisheriesMet, is.na(inf_slope)==FALSE) # remove all csquares with missing inf_slope
...
for (i in 1: length(Period)){
  ...
  # calculate inf_slope and inf_intercept and use RBS function
